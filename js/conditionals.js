 ...
 */
// how many inputs? 1
// what type inputs? string
// what type of output? string (a message which relates to the color stated in the argument of the function.)
...
var color = randomColor
    switch (randomColor) {
        ...
        case "blue":
            ...
            break;
        case "yellow":
            console.log("Yellow by Coldplay is the best song ever!");
            break;
        case "green":
            console.log("Shrek is a green ogre!");
            break;
        case "orange":
            console.log("Orange is the color of creamy french dressin!")
            break;
        default:
            console.log(" I don't know that color " + randomColor)
        }
